...
const data = [
  {
    ...
    rating: "4.7",
    review_Text:
      "Team TaxBuddy came to the rescue in crunch time. They were prompt, courteous and professional. Superlative service a super competitive price. Couldn't be more satisfied. Strongly recommended for every taxpayer in India who wants accurate...",
  },
  {
    name: "Rohan Baruah",
    time: "3 months ago",
  ...
  },
  {
    ...
    review_Text: (
      <>
        Positive : Quality. <br /> <br /> <br /> Right from the start the
        process was very smooth. The tax buddy assigned (Mr Gaurishankar) was
        extremely helpful, proactive, patient and answered all questions. Not
        only did I avail the service, because of the great experience, made my
        spouse use the service as well. recommend highly and continue the
        services again. I talked with Nikita Chilveri and my overall experience
        with tax buddy was so wonderful, they are so professional and the way
        Nikita explained everything to me was really helpful.
      </>
    ),
  },
  {
